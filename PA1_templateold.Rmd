...
The frequencies of the total number of steps per day ("values.per.day$tot.steps") are distributed as per the following histogram, where is added also a vertical line corresponding to the very close values of the median and of the mean of the total number of steps per day.
